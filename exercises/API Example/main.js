...
var myAPIKey = 161abf5d3b64f822c5f6cc9d84ce00e2
...
function onSubmit() {
	...
	{ "method" : "flickr.interestingness.getList",
	  "api_key" : "161abf5d3b64f822c5f6cc9d84ce00e2",
	  "format" : "json",
	  "nojsoncallback" : 1}
...
function onJSONSuccess( returnedData ) {
    ...
    // Here is a longer traditional way to iterate through 20 results
		for(i=0; i < count; i++ ) {
			...
			$aResult = $("<div class='photo'><h4>" + photo.title + "</h4> <img src = ' " + flickrImgUrl + "'> </div>");
...
//takes the flickr api documentation of how to create images from the data and build the URL for the image
function formatUrl( photoData ){
	//format according to site: https://farm{farm-id}.staticflickr.com/{server-id}/{id}_{secret}.jpg
